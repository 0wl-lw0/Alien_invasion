...
class Scoreboard():
    ...
    def __init__(self, ai_game):
        """Initializing attributtes count points."""
        ...
        # Settings font for showing score.
        self.text_color = (132, 68, 232)
        self.font = pygame.font.SysFont(None, 48)

        # Preparation images of score.
        self.prep_score()
    ...
    def prep_score(self):
        """Transform during score in image."""
        ...
        # Showing score in up-right side of display.
        self.score_rect = self.score_image.get_rect()
        self.score_rect.right = self.screen_rect.right - 20
        self.score_rect.top = 20

    def show_score(self):
        """Showing score on display."""
